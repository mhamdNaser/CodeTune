...
export default function Services() {
  return (
    <div className="flex flex-col pt-16" id="Services">
      ...
      <div className="p-12 w-[70%] m-auto text-primary-text">
        <div className="text-center mb-12">
          ...
          <p className="text-lg">
            We offer a range of services designed to elevate your digital
            presence and ensure your business thrives in the online world. Our
            team specializes in creating tailored solutions that meet your
            unique needs and help you achieve your goals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-blocks-color p-6 rounded-lg shadow-lg flex items-start">
            <div>
              ...
              <p className="mt-2 text-lg w-[95%]">
                ...
                platforms. From product management to secure payment gateways,
                we create seamless shopping experiences that drive sales and
          ...
          <div className="bg-blocks-color p-6 rounded-lg shadow-lg flex items-start">
            <div>
              ...
              <p className="mt-2 text-lg w-[95%]">
                Enhance your user experience with stunning, intuitive designs.
                We craft responsive and user-friendly interfaces that engage and
                delight your audience, ensuring a seamless interaction across
                all devices.
              </p>
            </div>
          </div>
