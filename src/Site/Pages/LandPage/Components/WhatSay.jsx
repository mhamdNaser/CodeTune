...
export default function WhatSay() {
  return (
    <div className="p-12 bg-blocks-color w-full">
      <div className="w-[70%] m-auto ">
        <div className="text-center mb-12 text-primary-text">
          ...
          <p className="text-lg">
            ...
            services. We take pride in delivering exceptional results and
            building lasting relationships. Read on to discover how we’ve made a
            difference for businesses like yours.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-primary-text">
          <div className="flex flex-col items-center relative bg-background-color p-6 rounded-lg shadow-lg">
