...
export default function Blog() {
  return (
    <div className="p-12 w-[70%] m-auto pt-48" id='blog'>
      <div className="text-start mb-12 text-primary-text">
        <h2 className="text-3xl font-bold mb-4">our blogs stories</h2>
        <p className="text-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-primary-text">
